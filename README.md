...
```bash
git clone https://github.com/Gauravpatil07/TheGaurav.git
cd TheGaurav
npm install
```
...
<p align="center">
  <img src="https://github.com/Gauravpatil07/TheGaurav/blob/main/public/GauravPortfolio.png" alt="Preview" width="100%" />
</p>
...
**Gaurav Patil**  
🔗 [https://www.thegaurav.dev](https://www.thegaurav.dev)  
📧 lt.gauravpatil@gmail.com
