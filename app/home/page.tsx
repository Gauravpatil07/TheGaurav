...
const imageMetadata = {
  profile1: {
    url: "/Gaurav_Patil.png",
    alt: "Gaurav Patil - Full Stack Developer Primary Profile",
    width: 800,
    height: 800,
  },
  profile2: {
    url: "/profile.jpg",
    alt: "Gaurav Patil - Full Stack Developer Alternate Profile",
    width: 800,
    height: 800,
  },
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Person",
              name: "Gaurav Patil",
              url: "https://thegaurav.dev",
              image: [
                `https://thegaurav.dev${imageMetadata.profile1.url}`,
                `https://thegaurav.dev${imageMetadata.profile2.url}`,
              ],
        ...
        >
          ...
          >
            <div id="home-title" className="text-2xl sm:text-4xl md:text-6xl lg:text-6xl font-bold">
              ...
              <span className="text-blue-500">Gaurav Patil</span>
            </div>
            ...
            >
              I turn coffee into code and bugs into features. Full-stack developer passionate about Java, React,
              and modern web technologies, always eager to learn, build, and create impactful digital solutions.
            </p>
            ...
            >
              ...
              >
                <MagneticButton>
                  <a
                    href="https://github.com/Gauravpatil07"
                    target="_blank"
                ...
                <MagneticButton>
                  <a
                    href="https://www.linkedin.com/in/gauravpatil07/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-blue-500 transition-colors duration-300 block p-2"
                  >
                ...
                <MagneticButton>
                  <a
                    href="https://x.com/gauravpatilop"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-blue-500 transition-colors duration-300 block p-2"
                  >
                ...
                <MagneticButton>
                  <a
                    href="https://discord.com/users/gauravcr7"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-blue-500 transition-colors duration-300 block p-2"
                  >
